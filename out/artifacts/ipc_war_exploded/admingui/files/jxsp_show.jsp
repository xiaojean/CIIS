          ...
          <TD vAlign=top height=200>
            ...
            align=center border=0>
              ...
              <TR>
				...
				<li><a href="listJxzy.action?tbdoc.typekey=gzzd">规章制度</a></li>
				<li><a href="listJxzy.action?tbdoc.typekey=jxjh">教学计划</a></li>
				<li><a href="listJxzy.action?tbdoc.typekey=jxdg">教学大纲</a></li>
				<li><a href="listJxzy.action?tbdoc.typekey=syjh">实验计划</a></li>	
				<li><a href="listJxzy.action?tbdoc.typekey=sydg">实验大纲</a></li>	
				<li><a href="listJxkj.action?tbfile.typekey=jxkj">教学课件</a></li>		
				<li><a href="listJxsp.action?tbfile.typekey=jxsp">教学视频</a></li>							
      ...
      cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD class=main_tdbg_575 vAlign=top height=200>
			...
			<TR>
			<TD align="center"> 			
			<SPAN>${tbfile.title}</SPAN> <SPAN >${tbfile.ptime}</SPAN>
			</Td>
			</tr>
			<tr>
			<td align="center">
			<DIV >			
				<embed src="<%=path%>/uploadfile/${tbfile.ranName}" width="695" height="472" autostart="true"></embed></DIV></TD>			
			</TR>
