...
<s:form action="addTbipc" enctype="multipart/form-data" method="post">
		  ...
		  <TR>
		    ...
		    <TD vAlign=top align=left width="100%" height=185>
		      ...
		      <TABLE height=17 cellSpacing=0 cellPadding=0 border=0>
		        <TBODY>
		        <TR>
		          <TD width=39><s:hidden name="tbipc.id"/></TD>
		      ...
		      border=0>
		        ...
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:combobox  list="{'历任领导','图片新闻','成果展示'}"
																size="20" maxlength="20" name="tbipc.typevalue"/></TD>
		          	</tr>
		          </table>
		          </td>
		          </TR>
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:textfield name="tbipc.title" cssClass="sc1_input2"   length="100" maxlength="200"/></TD>
		          	</tr>
		          </table>
		          </td>
		        ...
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:textfield name="tbipc.author" cssClass="sc1_input2"   length="100" maxlength="200"/></TD>
		          	</tr>
		          </table>
		          </td>
		          </TR>
		         ...
		         <td>
		          <table width="100%">
		          	<tr>
		          		...
		          		<sx:datetimepicker displayFormat="yyyy-MM-dd" name="tbipc.ptime"/> 
		          		</TD>
		          	</tr>
		          </table>
		          </td>
		      ...
		      <TABLE width="900" height=17 border=0 cellPadding=0 cellSpacing=0>
		        ...
		        <TR>
		          ...
		          <TD vAlign=top align=left width=865>
					<FCK:editor instanceName="tbipc.content" basePath="/fckeditor" value=" " width="100%" height="600"></FCK:editor>
					</td>
					</tr>
					</TBODY></TABLE>
		      </TD>
