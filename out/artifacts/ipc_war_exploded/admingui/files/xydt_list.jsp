...
<!-- saved from url=(0056) -->
<HTML><HEAD><TITLE>创新实践学院学院动态</TITLE>
  ...
  <TR>
    <TD vAlign=top width=199 bgColor=#fff0d9>
      <TABLE id=table20 cellSpacing=0 cellPadding=0 width=199 border=0>
        ...
        <TR>
          <TD width=199><IMG 
            height=36 src="images/xydt.jpg" width=199 
        border=0></TD></TR>
        <TR>
          <TD vAlign=top height=200>
            ...
            align=center border=0>
              ...
              <TR>
				...
				<li><a href="listXydt.action?tbdoc.typekey=xyxw">学院新闻</a></li>
				<li><a href="listXydt.action?tbdoc.typekey=tzgg">通知公告</a></li>
				<li><a href="listXydt.action?tbdoc.typekey=jxdt">教学动态</a></li>
				<li><a href="listXydt.action?tbdoc.typekey=cxdt">创新专题</a></li>				
      ...
      cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD class=main_tdbg_575 vAlign=top height=200>
			...
			<TR>
			<TD class=listbg vAlign=top width=10><IMG alt=固顶文章  src="images/Article_common.gif"></TD>
			<TD width=700 class=listbg>[<s:property  value="typevalue"/> ]<A class=listA  href="showXydt.action?tbdoc.id=<s:property  value="id"/>"  target=_blank><s:property  value="title"/></A></TD>
            ...
            <s:else> 
					<a href="listXydt.action?page=1" onClick="firstPage()"><img alt=首页 src="<%=request.getContextPath() %>/image/page_first.gif" border=0></a>
				
					<a href="listXydt.action?page=<s:property value="%{pageBean.currentPage-1}"/>"><img alt=上页 src="<%=request.getContextPath() %>/image/page_prio.gif" border=0></a>
			</s:else> 
			<s:if test="%{pageBean.currentPage != pageBean.totalPage}"> 
					<a href="listXydt.action?page=<s:property value="%{pageBean.currentPage+1}"/>"><img alt=下页 src="<%=request.getContextPath() %>/image/page_next.gif" border=0></a>
				
					<a href="listXydt.action?page=<s:property value="%{pageBean.totalPage}"/>"><img alt=尾页 src="<%=request.getContextPath() %>/image/page_last.gif" border=0></a>
			</s:if>  
             <s:else>  
