...
<!-- saved from url=(0056) -->
<HTML><HEAD><TITLE>创新实践学院成果展示</TITLE>
...
bgColor=#ffffff border=0>
  ...
  <TR>
    <TD vAlign=top width=199 bgColor=#fff0d9>
      <TABLE id=table20 cellSpacing=0 cellPadding=0 width=199 border=0>
        ...
        <TR>
          <TD width=199><IMG 
            height=36 src="images/cgzs.jpg" width=199 
        border=0></TD></TR>
        <TR>
          <TD vAlign=top height=200>
            ...
            align=center border=0>
              ...
              <TR>
				...
				<li><a href="<%=path%>/listCgzs.action?tbipc.typekey=cgzs">成果展示</a></li>
				<!-- 
				<li><a href="listTbdoc.action?tbdoc.typekey=tzgg">通知公告</a></li>
				<li><a href="listTbdoc.action?tbdoc.typekey=jxdt">教学动态</a></li>
				<li><a href="listTbdoc.action?tbdoc.typekey=czzt">创新专题</a></li>				
      ...
      cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD class=main_tdbg_575 vAlign=top height=200>
			...
			<TR>
			<TD class=listbg vAlign=top width=10><IMG alt=成果展示  src="<%=path%>/images/Article_common.gif"></TD>
			<TD width=700 class=listbg>[<s:property  value="typevalue"/> ]<A class=listA  href="<%=path%>/showCgzs.action?tbipc.id=<s:property  value="id"/>"  target=_blank><s:property  value="title"/></A></TD>
  ...
  <table class=table_tool cellSpacing=0 cellPadding=3 border=0 >
            ...
            <s:else> 
					<a href="listCgzs.action?page=1" onClick="firstPage()"><img alt=首页 src="<%=request.getContextPath() %>/image/page_first.gif" border=0></a>
				
					<a href="listCgzs.action?page=<s:property value="%{pageBean.currentPage-1}"/>"><img alt=上页 src="<%=request.getContextPath() %>/image/page_prio.gif" border=0></a>
			</s:else> 
			<s:if test="%{pageBean.currentPage != pageBean.totalPage}"> 
					<a href="listCgzs.action?page=<s:property value="%{pageBean.currentPage+1}"/>"><img alt=下页 src="<%=request.getContextPath() %>/image/page_next.gif" border=0></a>
				
					<a href="listCgzs.action?page=<s:property value="%{pageBean.totalPage}"/>"><img alt=尾页 src="<%=request.getContextPath() %>/image/page_last.gif" border=0></a>
			</s:if>  
             <s:else>  
