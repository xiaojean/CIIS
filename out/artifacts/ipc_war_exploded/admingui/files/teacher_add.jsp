...
<%} %>
<s:form action="addTbteacher" enctype="multipart/form-data" method="post">
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#ffffff border=0>
		  ...
		  <TR>
		    ...
		    <TD vAlign=top align=left width="100%" height=185>
		      <TABLE height=22 cellSpacing=0 cellPadding=0 border=0 width="100%" bgColor=#ffffff>
		        <TBODY>
		        <TR>
		          <TD width=38></TD>
		      ...
		      <TABLE height=17 cellSpacing=0 cellPadding=0 border=0>
		        <TBODY>
		        <TR>
		          <TD width=39><s:hidden name="tbteacher.id"/></TD>
		      ...
		      border=0>
		        ...
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:textfield name="tbteacher.tid" cssClass="sc1_input2"   length="100" maxlength="200"/>
		          	</tr>
		          </table>
		          </td>
		          </TR>
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:textfield name="tbteacher.tpwd" cssClass="sc1_input2"   length="100" maxlength="200"/></TD>
		          	</tr>
		          </table>
		          </td>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:combobox  list="{'管理员','学院领导','普通教师'}"
																size="20" maxlength="20" name="tbteacher.power"/></TD>
		          	</tr>
		          </table>
		          </td>
		          </TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:textfield name="tbteacher.tname" cssClass="sc1_input2"   length="100" maxlength="200"/></TD>
		          	</tr>
		          </table>
		          </td>
		         ...
		         <td>
		          <table width="100%">
		          	<tr>
		          		...
		          		<sx:datetimepicker displayFormat="yyyy-MM-dd" name="tbteacher.ptime"/> 
		          		</TD>
		          	</tr>
		          </table>
		          </td>
		      ...
		      <TABLE width="900" height=17 border=0 cellPadding=0 cellSpacing=0>
		        ...
		        <TR>
		          ...
		          <TD vAlign=top align=left width=865>
					<FCK:editor instanceName="tbteacher.content" basePath="/fckeditor" value=" " width="100%" height="600"></FCK:editor>
					</td>
					</tr>
					</TBODY></TABLE>
		      </TD>
