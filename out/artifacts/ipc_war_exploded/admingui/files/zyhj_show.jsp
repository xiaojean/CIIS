...
<!-- saved from url=(0056) -->
<HTML><HEAD><TITLE>创新实践学院资源环境</TITLE>
  ...
  <TR>
    <TD vAlign=top width=199 bgColor=#fff0d9>
      <TABLE id=table20 cellSpacing=0 cellPadding=0 width=199 border=0>
        ...
        <TR>
          <TD width=199><IMG 
            height=36 src="images/zyhj.jpg" width=199 
        border=0></TD></TR>
        <TR>
          <TD vAlign=top height=200>
            ...
            align=center border=0>
              ...
              <TR>
				...
				<li><a href="listJxzy.action?tbdoc.typekey=jxkj">教学课件</a></li>		
				<li><a href="listJxzy.action?tbdoc.typekey=jxsp">教学视频</a></li>		
