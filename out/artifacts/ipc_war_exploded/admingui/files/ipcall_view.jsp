...
<s:form action="viewTbipc" enctype="multipart/form-data" method="post">
		    ...
		    <TD vAlign=top align=left width="100%" height=185>
		      ...
		      border=0>
		        ...
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle ><s:property value="%{tbipc.typevalue}"/></TD>
		          	</tr>
		          </table>
		          </td>
		          </TR>
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:property value="%{tbipc.title}"/></TD>
		          	</tr>
		          </table>
		        ...
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:property value="%{tbipc.author}"/></TD>
		          	</tr>
		          </table>
		          </td>
		          </TR>
		         ...
		         <td>
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle >${tbipc.ptime}</TD>
		          	</tr>
		          </table>
		          </td>
		          </TR></TBODY></TABLE></TD>
		      ...
		      <TABLE width="900" height=17 border=0 cellPadding=0 cellSpacing=0>
		        ...
		        <TR>
		          ...
		          <TD vAlign=top align=left width=865>
					<FCK:editor instanceName="tbipc.content" basePath="/fckeditor" value="${tbipc.content}" width="800" height="600"></FCK:editor>
					</td>
					</tr>
					</TBODY></TABLE>
		      </TD>
