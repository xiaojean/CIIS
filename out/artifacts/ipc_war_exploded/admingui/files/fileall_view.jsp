...
<s:form action="viewTbfile" enctype="multipart/form-data" method="post">
		    ...
		    <TD vAlign=top align=left width="100%" height=185>
		      ...
		      border=0>
		        ...
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle ><s:property value="%{tbfile.typevalue}"/></TD>
		          	</tr>
		          </table>
		          </td>
		          </TR>
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:property value="%{tbfile.title}"/></TD>
		          	</tr>
		          </table>
		        ...
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:property value="%{tbfile.author}"/></TD>
		          	</tr>
		          </table>
		          </td>
		          </TR>
		         ...
		         <td>
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle >${tbfile.ptime}</TD>
		          	</tr>
		          </table>
		          </td>
		          </TR></TBODY></TABLE></TD>
