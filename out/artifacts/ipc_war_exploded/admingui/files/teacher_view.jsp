...
<tr>
<td><s:hidden name="tbipc.id" value="%{tbteacher.id}"></s:hidden></td>
<tbody>
	<tr>
		<td>
		    ...
		    <TD vAlign=top align=left width="100%" height=185>
		      ...
		      border=0>
		        ...
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:property value="%{tbteacher.tid}"/>
		          	</tr>
		          </table>
		          </td>
		          </TR>
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:property value="%{tbteacher.tpwd}"/></TD>
		          	</tr>
		          </table>
		          </td>
		          ...
		          <TR>
		          <TD height=40>&nbsp; </TD>
		          <TD class=sc1_z01 vAlign=middle align=left>教师 权限： </TD>
		          <td width="1018">
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:property value="%{tbteacher.power}"/></TD>
		          	</tr>
		          </table>
		          </td>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:property value="%{tbteacher.tname}"/></TD>
		          	</tr>
		          </table>
		          </td>
