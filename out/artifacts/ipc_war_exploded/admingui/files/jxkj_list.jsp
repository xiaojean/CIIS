...
<!-- saved from url=(0056) -->
<HTML><HEAD><TITLE>创新实践学院教学课件下载</TITLE>
  ...
  <TR>
    <TD vAlign=top width=199 bgColor=#fff0d9>
      <TABLE id=table20 cellSpacing=0 cellPadding=0 width=199 border=0>
        ...
        <TR>
          <TD width=199><IMG 
            height=36 src="images/jxzy.jpg" width=199 
        border=0></TD></TR>
        <TR>
          <TD vAlign=top height=200>
            ...
            align=center border=0>
              ...
              <TR>
				...
				<li><a href="<%=path%>/listJxzy.action?tbdoc.typekey=gzzd">规章制度</a></li>
				<li><a href="<%=path%>/listJxzy.action?tbdoc.typekey=jxjh">教学计划</a></li>
				<li><a href="<%=path%>/listJxzy.action?tbdoc.typekey=jxdg">教学大纲</a></li>
				<li><a href="<%=path%>/listJxzy.action?tbdoc.typekey=syjh">实验计划</a></li>	
				<li><a href="<%=path%>/listJxzy.action?tbdoc.typekey=sydg">实验大纲</a></li>	
				<li><a href="<%=path%>/listJxkj.action?tbfile.typekey=jxkj">教学课件</a></li>		
				<li><a href="<%=path%>/listJxsp.action?tbfile.typekey=jxsp">教学视频</a></li>				
      ...
      cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD class=main_tdbg_575 vAlign=top height=200>
			...
			<TR>
			<TD class=listbg vAlign=top width=10><IMG alt<s:property  value="title"/>  src="images/Article_common.gif"></TD>
			<TD width=700 class=listbg>[<s:property  value="typevalue"/> ]<A class=listA  href="fileDownload.action?fileName=<s:property  value="ranName"/>"  target=_blank><s:property  value="title"/></A></TD>
	...
	<table class=table_tool cellSpacing=0 cellPadding=3 border=0 >
            ...
            <s:else> 
					<a href="listJxkj.action?page=1" onClick="firstPage()"><img alt=首页 src="<%=request.getContextPath() %>/image/page_first.gif" border=0></a>
				
					<a href="listJxkj.action?page=<s:property value="%{pageBean.currentPage-1}"/>"><img alt=上页 src="<%=request.getContextPath() %>/image/page_prio.gif" border=0></a>
			</s:else> 
			<s:if test="%{pageBean.currentPage != pageBean.totalPage}"> 
					<a href="listJxkj.action?page=<s:property value="%{pageBean.currentPage+1}"/>"><img alt=下页 src="<%=request.getContextPath() %>/image/page_next.gif" border=0></a>
				
					<a href="listJxkj.action?page=<s:property value="%{pageBean.totalPage}"/>"><img alt=尾页 src="<%=request.getContextPath() %>/image/page_last.gif" border=0></a>
			</s:if>  
             <s:else>  
