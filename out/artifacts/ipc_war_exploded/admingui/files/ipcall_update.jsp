...
<s:form action="updateTbipc" enctype="multipart/form-data" method="post">
<table width="100%" height="100%">

<tr>
<td><s:hidden name="tbipc.id" value="%{tbipc.id}"></s:hidden></td>
<tbody>
	<tr>
		<td>
		    ...
		    <TD vAlign=top align=left width="100%" height=185>
		      ...
		      border=0>
		        ...
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:property value="%{tbipc.typevalue}"/>
															<s:hidden name="tbipc.typevalue" value="%{tbipc.typevalue}"></s:hidden></TD>
		          	</tr>
		          </table>
		          </td>
		          </TR>
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:textfield  cssClass="sc1_input2" name="tbipc.title"  value="%{tbipc.title}"  /></TD>
		          	</tr>
		          </table>
		          </td>
		        ...
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:textfield name="tbipc.author" cssClass="sc1_input2" value="%{tbipc.author}"  length="100" maxlength="200"/></TD>
		          	</tr>
		          </table>
		          </td>
		          </TR>
		         ...
		         <td>
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <sx:datetimepicker displayFormat="yyyy-MM-dd" name="tbipc.ptime" cssClass="sc1_input2"  value="%{tbipc.ptime}"  /></TD>
		          	</tr>
		          </table>
		          </td>
		          </TR> -->
		      ...
		      <TABLE width="900" height=17 border=0 cellPadding=0 cellSpacing=0>
		        ...
		        <TR>
		          ...
		          <TD vAlign=top align=left width=865>
					<FCK:editor instanceName="tbipc.content" basePath="/fckeditor" value="${tbipc.content}"  width="100%" height="600"></FCK:editor>
					</td>
					</tr>
					</TBODY></TABLE>
		      </TD>
