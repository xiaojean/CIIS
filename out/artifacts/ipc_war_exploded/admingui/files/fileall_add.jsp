...
<link href="<%=path %>/css/manage.css" type=text/css rel=stylesheet>
...
<s:form action="addTbfile" enctype="multipart/form-data" method="post">
		  ...
		  <TR>
		    ...
		    <TD vAlign=top align=left width="100%" height=185>
		      ...
		      <TABLE height=17 cellSpacing=0 cellPadding=0 border=0>
		        <TBODY>
		        <TR>
		          <TD width=39><s:hidden name="tbfile.id"/></TD>
		      ...
		      border=0>
		        ...
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:combobox  list="{'文件下载','教学课件' ,'教学视频'}"
																size="20" maxlength="20" name="tbfile.typevalue"/></TD>
		          	</tr>
		          </table>
		          </td>
		          </TR>
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:textfield name="tbfile.title" cssClass="sc1_input2"   length="100" maxlength="200"/></TD>
		          	</tr>
		          </table>
		          </td>
		        ...
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:textfield name="tbfile.author" cssClass="sc1_input2"   length="100" maxlength="200"/></TD>
		          	</tr>
		          </table>
		          </td>
		          </TR>
		         ...
		         <td>
		          <table width="100%">
		          	<tr>
		          		...
		          		<sx:datetimepicker displayFormat="yyyy-MM-dd" name="tbfile.ptime"/> 
		          		</TD>
		          	</tr>
		          </table>
		          </td>
