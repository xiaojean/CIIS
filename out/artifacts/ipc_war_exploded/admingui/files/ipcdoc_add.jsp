...
<s:form action="addTbdoc" enctype="multipart/form-data" method="post">
		  ...
		  <TR>
		    ...
		    <TD vAlign=top align=left width="100%" height=185>
		      ...
		      <TABLE height=17 cellSpacing=0 cellPadding=0 border=0>
		        <TBODY>
		        <TR>
		          <TD width=39><s:hidden name="tbdoc.id"/></TD>
		      ...
		      border=0>
		        ...
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:combobox  list="{'学院简介','院长致辞','师资力量','学院新闻','教学动态','通知公告','创新动态','教改项目','课程建设','教材建设','教学论文','教学荣誉','科研项目','规章制度','教学计划','实验计划','教学大纲','实验大纲','资源环境'}"
																size="20" maxlength="20" name="tbdoc.typevalue"/></TD>
		          	</tr>
		          </table>
		          </td>
		          </TR>
		        <TR>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:textfield name="tbdoc.title" cssClass="sc1_input2"   length="100" maxlength="200"/></TD>
		          	</tr>
		          </table>
		          </td>
		        ...
		        <tr>
		          ...
		          <table width="100%">
		          	<tr>
		          		<TD  align=left vAlign=middle > <s:textfield name="tbdoc.author" cssClass="sc1_input2"   length="100" maxlength="200"/></TD>
		          	</tr>
		          </table>
		          </td>
		          </TR>
		         ...
		         <td>
		          <table width="100%">
		          	<tr>
		          		...
		          		<sx:datetimepicker displayFormat="yyyy-MM-dd" name="tbdoc.ptime"/> 
		          		</TD>
		          	</tr>
		          </table>
		          </td>
		      ...
		      <TABLE width="900" height=17 border=0 cellPadding=0 cellSpacing=0>
		        ...
		        <TR>
		          ...
		          <TD vAlign=top align=left width=865>
					<FCK:editor instanceName="tbdoc.content" basePath="/fckeditor" value=" " width="100%" height="600"></FCK:editor>
					</td>
					</tr>
					</TBODY></TABLE>
		      </TD>
