...
<!-- saved from url=(0056) -->
<HTML><HEAD><TITLE>创新实践学院教学视频</TITLE>
...
bgColor=#ffffff border=0>
      ...
      cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD class=main_tdbg_575 vAlign=top height=200>
			...
			<TD width=700 class=listbg>[<s:property  value="typevalue"/> ]<A class=listA  href="videoShow.action?tbfile.id=<s:property  value="id"/>"  target=_blank><s:property  value="title"/></A></TD>
  ...
  <table class=table_tool cellSpacing=0 cellPadding=3 border=0 >
            ...
            <s:else> 
					<a href="listJxsp.action?page=1" onClick="firstPage()"><img alt=首页 src="<%=request.getContextPath() %>/image/page_first.gif" border=0></a>
				
					<a href="listJxsp.action?page=<s:property value="%{pageBean.currentPage-1}"/>"><img alt=上页 src="<%=request.getContextPath() %>/image/page_prio.gif" border=0></a>
			</s:else> 
			<s:if test="%{pageBean.currentPage != pageBean.totalPage}"> 
					<a href="listJxsp.action?page=<s:property value="%{pageBean.currentPage+1}"/>"><img alt=下页 src="<%=request.getContextPath() %>/image/page_next.gif" border=0></a>
				
					<a href="listJxsp.action?page=<s:property value="%{pageBean.totalPage}"/>"><img alt=尾页 src="<%=request.getContextPath() %>/image/page_last.gif" border=0></a>
			</s:if>  
             <s:else>  
