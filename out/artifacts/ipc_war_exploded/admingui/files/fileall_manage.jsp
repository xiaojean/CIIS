  ...
  <table cellSpacing=1 cellPadding=0 width="100%" bgColor=#d4d0c8 border=0>
    <tbody>		
		...
		<tr class=toptr3>
			...
			<td><s:property  value="ranName"/></td>
			<td><s:property  value="author"/></td>
			<td><s:property  value="ptime"/></td>				
   						
   			<td><s:a href="updatePTbfile.action?tbfile.id=%{#pl.id}">修改</s:a>
   			
   			</td>
   			<td><s:a href="deleteTbfile.action?tbfile.id=%{#pl.id}" onclick="return del();">删除</s:a>
