...
,	initOptions = function () {
		...
		function createFxOptions ( pane ) {
			...
			// DONE creating JsonTestAction-specific-settings for this pane,
...
,	close = function (evt_or_pane, force, noAnimation, skipCallback) {
		...
		// QUEUE in case another JsonTestAction/animation is in progress
 ...
 */
	...
	// create Instance object to expose data & option Properties, and primary JsonTestAction Methods
	var Instance = {
	//	layout data
...
$.layout.buttons = {
	...
	*  - ui-layout-button-pin		// JsonTestAction btnClass
	*  - ui-layout-button-pin-west	// JsonTestAction btnClass + pane
